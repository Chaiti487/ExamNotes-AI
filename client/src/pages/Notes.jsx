      ...
      >
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <button
            ...
            className="px-4 py-2 rounded-full text-sm font-medium bg-white/10 border border-white/20 text-white hover:bg-white/20 transition flex items-center gap-2"
          >
            📚 Your Notes
          </button>
        </div>
