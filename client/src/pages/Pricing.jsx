...
function Pricing() {
    ...
    const [selestedPrice , setSelectedPrice] = useState(null);
   ...
   return(
    ...
    ${isSelected
      ...
      : "border-gray-200"
        ...
        {isSelected && <span className='absolute top-4 right-4 text-xs px-2 py-1 rounded bg-black text-white'>Selected
            </span>}
